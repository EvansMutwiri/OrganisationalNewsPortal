...
public class Sql2oNewsDao implements NewsDao {
    ...
    public void add(News news) {
        String sql = "INSERT INTO news (heading, content, writtenBy, departmentId) VALUES (:heading, :content, :writtenBy, :departmentId)"; //if you change your model, be sure to update here as well!
